      ...
      >
        <div style={{ display: "flex", flexDirection: "row" }}>
          ...
          >
            {showIntroOption === true && (
              <option
                ...
                selected
                style={{
                  ...introOptionStyles.style,
                  ...introOptionStyles.addStyle
                }}
          ...
          {selectExternalComponent2 !== null && (
            <div>{selectExternalComponent2}</div>
          )}
        </div>
        <div
          style={{
