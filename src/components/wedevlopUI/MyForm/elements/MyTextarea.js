...
class MyTextarea extends React.Component {
  ...
  render() {
    ...
    return (
      <div
        style={{
          ...textareaContainerStyles.style,
          ...textareaContainerStyles.addStyle
        }}
      ...
      >
        ...
        >
          ...
          {textareaExternalComponent2 !== null && (
            <div>{textareaExternalComponent2}</div>
          )}
          <span
            style={{
              ...textareaSpan2Styles.style,
              ...textareaSpan2Styles.addStyle
            }}
